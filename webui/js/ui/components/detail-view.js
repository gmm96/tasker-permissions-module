...
export function renderContent(appViewModel, onCheckboxChange)
{
...
export function setAllCheckboxes(checked, onCheckboxChange)
{
...
export function filterPermissions(query)
{
...
export function renderDetailActionButtons(appViewModel)
{
